...
export class LoadingBarContainer extends Container {
    ...
    constructor(barWidth: number, parentWidth: number, parentHeight: number) {
        ...
        this._loaderBar.position.x = (parentWidth - this._loaderBar.width) * 0.5;
        this._loaderBar.position.y = (parentHeight - this._loaderBar.height) * 0.6;
    ...
    resize(width: number, height: number) {
        this._loaderBar.position.x = (width - this._loaderBar.width) * 0.5;
        this._loaderBar.position.y = (height - this._loaderBar.height) * 0.5;
    }
